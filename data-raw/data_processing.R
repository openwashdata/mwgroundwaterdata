...
data_in <- readr::read_csv("data-raw/groundwatermonitoring.csv")
...
# Export Data ------------------------------------------------------------------
usethis::use_data(mwgroundwaterdata, overwrite = TRUE)
fs::dir_create(here::here("inst", "extdata"))
readr::write_csv(mwgroundwaterdata,
                 here::here("inst", "extdata", paste0("mwgroundwaterdata", ".csv")))
openxlsx::write.xlsx(mwgroundwaterdata,
                     here::here("inst", "extdata", paste0("mwgroundwaterdata",
                                                          ".xlsx")))
